...
The dataframe (KL_df) created in KatieLiu_bilingualism.Rmd contains the variables that are needed for this analysis. Therefore, we will continue using KL_df in this project.


```{r}
load("data/KL_df.Rdata") #contains Stroop, Flanker, and questionnaire data.
subjects_NLP_sentence<-read_csv("/Users/pcmamiya/Documents/NLP_Bilingualism/BehavioralData/Stroop_Flanker/Bilingualism_NLP_behaivor/formatted_data.csv")
...
write.csv(Subjects_num_sentences, file = "/Users/pcmamiya/Documents/NLP_Bilingualism/BehavioralData/Stroop_Flanker/Bilingualism_NLP_behaivor/data/Subjectgs_num_sentences.csv")
```
...
write.csv(Subjects_lexical, file = "/Users/pcmamiya/Documents/NLP_Bilingualism/BehavioralData/Stroop_Flanker/Bilingualism_NLP_behaivor/data/Subjects_lexical.csv")
```

```{r}
#read in Stroop and Flanker error rates. Created in MATLAB on July 6, 2021
Stroop_errors <-readMat("/Users/pcmamiya/Documents/NLP_Bilingualism/BehavioralData/Stroop_ErrorRate_06July2021.mat")
...
write.csv(Stroop_ErrorRate, file = "/Users/pcmamiya/Documents/NLP_Bilingualism/BehavioralData/Stroop_Flanker/Bilingualism_NLP_behaivor/data/Stroop_ErrorRate.csv")
```



```{r}
Flanker_errors <-readMat("/Users/pcmamiya/Documents/NLP_Bilingualism/BehavioralData/Flanker_ErrorRate_06July2021.mat")
...
write.csv(Flanker_ErrorRate, file = "/Users/pcmamiya/Documents/NLP_Bilingualism/BehavioralData/Stroop_Flanker/Bilingualism_NLP_behaivor/data/Flanker_ErrorRate.csv")
```

```{r}
#subjects_TimeWords <-read_xlsx("/Users/pcmamiya/Documents/NLP_Bilingualism/BehavioralData/Stroop_Flanker/Bilingualism_NLP_behaivor/SpeechTranscription_22Nov2020.xlsx", sheet = "TimeWords")
```
...
YM_df[,339:343]
write.csv(YM_df, file = "/Users/pcmamiya/Documents/NLP_Bilingualism/BehavioralData/Stroop_Flanker/Bilingualism_NLP_behaivor/data/YM_df.csv")
```
